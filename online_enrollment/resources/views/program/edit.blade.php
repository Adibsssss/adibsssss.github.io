                ...
                <form action="{{ route('program.update', $program) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="year_level" id="year_level" required
                            ...
                            <option value="1" {{ old('year_level', $program->year_level) == 1 ? 'selected' : '' }}>1st
                                Year</option>
                            <option value="2" {{ old('year_level', $program->year_level) == 2 ? 'selected' : '' }}>2nd
                                Year</option>
                            <option value="3" {{ old('year_level', $program->year_level) == 3 ? 'selected' : '' }}>3rd
                                Year</option>
                            <option value="4" {{ old('year_level', $program->year_level) == 4 ? 'selected' : '' }}>4th
                                Year</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="semester" id="semester" required
                            ...
                            <option value="1" {{ old('semester', $program->semester) == 1 ? 'selected' : '' }}>1st
                                Semester</option>
                            <option value="2" {{ old('semester', $program->semester) == 2 ? 'selected' : '' }}>2nd
                                Semester</option>
                        </select>
                    </div>
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="courses[]" value="{{ $course->id }}"
                                        ...
                                        {{ in_array($course->id, old('courses', $program->courses->pluck('id')->toArray())) ? 'checked' : '' }}>
