...
<div class="max-w-3xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100">Add New Product</h2>
        ...
        <form method="POST" action="{{ route('products.store') }}">
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description"
                    class="w-full rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
            </div>
